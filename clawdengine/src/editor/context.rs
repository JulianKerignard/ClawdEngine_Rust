...
pub struct UndoStack {
    undo: std::collections::VecDeque<UndoEntry>,
    redo: std::collections::VecDeque<UndoEntry>,
}

impl UndoStack {
    pub fn new() -> Self {
        Self { undo: std::collections::VecDeque::new(), redo: std::collections::VecDeque::new() }
    }
